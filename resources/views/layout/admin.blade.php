...
<html class="loading" lang="en" data-textdirection="rtl">
  ...
  <head>
    ...
    <title>Layout Boxed - Vuexy - Bootstrap HTML admin template</title>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mr-auto"><a class="navbar-brand" href="../../../starter-kit/rtl/vertical-collapsed-menu-template/"><span class="brand-logo">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="layout"></i><span class="menu-title text-truncate" data-i18n="Page Layouts">Page Layouts</span><span class="badge badge-light-danger badge-pill ml-auto mr-1">2</span></a>
            <ul class="menu-content">
              ...
              <li class="active"><a class="d-flex align-items-center" href="layout-boxed.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Layout Boxed">Layout Boxed</span></a>
              </li>
        ...
        <div class="content-body"><div class="row">
           <div class="col-12">
               ...
               @if ($message = Session::get('success'))
                     <button type="button" class="btn btn-outline-success waves-effect" id="type-success" value="{{ $message }}">Success</button>
                     {{-- <div id="type-success">{{ $message }}</div> --}}
               @endif 
           </div>
         </div>
